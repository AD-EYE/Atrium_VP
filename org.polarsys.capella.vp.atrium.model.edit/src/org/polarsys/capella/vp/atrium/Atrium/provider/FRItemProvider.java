...
/**
 * This is the item provider adapter for a {@link org.polarsys.capella.vp.atrium.Atrium.FR} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FRItemProvider extends AtriumBasicElementItemProvider implements IEditingDomainItemProvider,
	 ...
	 * @generated
	 */
	public FRItemProvider(AdapterFactory adapterFactory) {
	...
	public void checkChildCreationExtender(Object object) {
		...
		if (object instanceof EObject) {
			...
			// Process AtriumPackage.Literals.FR__LINKED_ASSUMPTION
			if (linkedAssumptionPropertyDescriptor != null) {
				Object linkedAssumptionValue = eObject.eGet(AtriumPackage.Literals.FR__LINKED_ASSUMPTION, true);
				if (linkedAssumptionValue != null && linkedAssumptionValue instanceof EObject && ModelExtensionHelper
					...
					itemPropertyDescriptors.remove(linkedAssumptionPropertyDescriptor);
						...
						AtriumPackage.Literals.FR__LINKED_ASSUMPTION) != null) {
					itemPropertyDescriptors.remove(linkedAssumptionPropertyDescriptor);
	...
	protected void addLinkedAssumptionPropertyDescriptor(Object object) {
		...
		(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_FR_linkedAssumption_feature"), //$NON-NLS-1$
				getString("_UI_PropertyDescriptor_description", "_UI_FR_linkedAssumption_feature", "_UI_FR_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				AtriumPackage.Literals.FR__LINKED_ASSUMPTION, true, false, true, null, null,
				// begin-extension-code
				null);
		itemPropertyDescriptors.add(linkedAssumptionPropertyDescriptor);
		// end-extension-code
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/FR")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		...
		String label = ((FR) object).getName();
		// begin-extension-code
		return label == null || label.length() == 0 ? "[" + getString("_UI_FR_type") + "]" : label; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		// end-extension-code
	}
