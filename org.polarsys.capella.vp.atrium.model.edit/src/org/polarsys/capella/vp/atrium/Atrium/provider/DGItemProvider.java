...
/**
 * This is the item provider adapter for a {@link org.polarsys.capella.vp.atrium.Atrium.DG} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DGItemProvider extends NamedElementItemProvider implements IEditingDomainItemProvider,
	 ...
	 * @generated
	 */
	public DGItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This adds a property descriptor for the Design Alternative feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addDesignAlternativePropertyDescriptor(Object object) {
	...
	protected void addContentPropertyDescriptor(Object object) {
		...
		// end-extension-code
		(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_DG_content_feature"), //$NON-NLS-1$
				getString("_UI_PropertyDescriptor_description", "_UI_DG_content_feature", "_UI_DG_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				AtriumPackage.Literals.DG__CONTENT, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
				null,
				// begin-extension-code
				null));
		// end-extension-code
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DG")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		...
		String label = ((DG) object).getName();
		// begin-extension-code
		return label == null || label.length() == 0 ? "[" + getString("_UI_DG_type") + "]" : label; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		// end-extension-code
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DG.class)) {
