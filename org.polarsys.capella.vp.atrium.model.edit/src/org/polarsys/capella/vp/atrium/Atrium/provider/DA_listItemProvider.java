...
/**
 * This is the item provider adapter for a {@link org.polarsys.capella.vp.atrium.Atrium.DA_list} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DA_listItemProvider extends NamedElementItemProvider implements IEditingDomainItemProvider,
	 ...
	 * @generated
	 */
	public DA_listItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DA_list")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		...
		String label = ((DA_list) object).getName();
		// begin-extension-code
		return label == null || label.length() == 0 ? "[" + getString("_UI_DA_list_type") + "]" : label; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		// end-extension-code
	}
