...
/**
 * This is the item provider adapter for a {@link org.polarsys.capella.vp.atrium.Atrium.DA} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DAItemProvider extends NamedElementItemProvider implements IEditingDomainItemProvider,
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addIsPartOfSelectionPropertyDescriptor(object);
		}
	...
	protected void addContentPropertyDescriptor(Object object) {
		...
		(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_DA_content_feature"), //$NON-NLS-1$
				getString("_UI_PropertyDescriptor_description", "_UI_DA_content_feature", "_UI_DA_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				AtriumPackage.Literals.DA__CONTENT, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
				null,
				// begin-extension-code
				null));
		// end-extension-code
	...
	/**
	 * This adds a property descriptor for the Is Part Of Selection feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addIsPartOfSelectionPropertyDescriptor(Object object) {

		// begin-extension-code
		itemPropertyDescriptors.add(createItemPropertyDescriptor
		// end-extension-code
		(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_DA_isPartOfSelection_feature"), //$NON-NLS-1$
				getString("_UI_PropertyDescriptor_description", "_UI_DA_isPartOfSelection_feature", "_UI_DA_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				AtriumPackage.Literals.DA__IS_PART_OF_SELECTION, true, false, false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DA")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		...
		// begin-extension-code
		return label == null || label.length() == 0 ? "[" + getString("_UI_DA_type") + "]" : label; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		// end-extension-code
	}
