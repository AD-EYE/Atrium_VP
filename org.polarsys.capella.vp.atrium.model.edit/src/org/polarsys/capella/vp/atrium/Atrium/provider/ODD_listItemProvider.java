...
/**
 * This is the item provider adapter for a {@link org.polarsys.capella.vp.atrium.Atrium.ODD_list} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ODD_listItemProvider extends NamedElementItemProvider implements IEditingDomainItemProvider,
	 ...
	 * @generated
	 */
	public ODD_listItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ODD_list")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		...
		String label = ((ODD_list) object).getName();
		// begin-extension-code
		return label == null || label.length() == 0 ? "[" + getString("_UI_ODD_list_type") + "]" : label; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		// end-extension-code
	}
