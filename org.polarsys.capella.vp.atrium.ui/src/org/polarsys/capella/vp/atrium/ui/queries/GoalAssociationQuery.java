...
/**
 * <!-- begin-user-doc -->
* The '<em><b>[GoalAssociationQuery]</b></em>' BusinessQuery defined for 
* '<em><b>[AtriumPackage.eINSTANCE.getCFA_Goal()]</b></em>'.
* <!-- end-user-doc -->
 * <p>
 * </p>
 *
 * @generated
 */
public class GoalAssociationQuery implements IBusinessQuery {
	...
	public List<EObject> getCurrentElements(EObject element_p, boolean onlyGenerated_p) {
		...
		result.add(((CFA) element_p).getGoal());
		return result;
	}
	...
	public List<EReference> getEStructuralFeatures() {
		...
		eReferences.add(AtriumPackage.eINSTANCE.getCFA_Goal());
		return eReferences;
	}
