...
/**
 * <!-- begin-user-doc -->
* The '<em><b>[DGsAssociationQuery]</b></em>' BusinessQuery defined for 
* '<em><b>[AtriumPackage.eINSTANCE.getDG_list_DGs()]</b></em>'.
* <!-- end-user-doc -->
 * <p>
 * </p>
 *
 * @generated
 */
public class DGsAssociationQuery implements IBusinessQuery {
	...
	*/
	...
	public List<EObject> getCurrentElements(EObject elementP, boolean onlyGeneratedP) {
		...
		if (elementP instanceof DG_list)
			currentsElements.addAll(((DG_list) elementP).getDGs());
	...
	public List<EReference> getEStructuralFeatures() {
		...
		eReferences.add(AtriumPackage.eINSTANCE.getDG_list_DGs());
		return eReferences;
	}
}
