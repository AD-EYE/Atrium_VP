...
// Generated on 08.07.2020 at 11:33:34 CEST by Viewpoint DSL Generator V 0.1
...
/**
 * <!-- begin-user-doc -->
* The '<em><b>[LinkedtoElementAssociationQuery]</b></em>' BusinessQuery defined for 
* '<em><b>[AtriumPackage.eINSTANCE.getCFA_LinkedtoElement()]</b></em>'.
* <!-- end-user-doc -->
 * <p>
 * </p>
 *
 * @generated
 */
public class LinkedtoElementAssociationQuery implements IBusinessQuery {
	...
	public List<EObject> getAvailableElements(EObject element_p) {
		...
		if (null != systemEngineering) {
			Set<EObject> all = EObjectExt.getAll(systemEngineering, CapellacorePackage.Literals.CAPELLA_ELEMENT);
	...
	public List<EObject> getCurrentElements(EObject element_p, boolean onlyGenerated_p) {
		...
		result.add(((CFA) element_p).getLinkedtoElement());
		return result;
	}
	...
	public List<EReference> getEStructuralFeatures() {
		...
		eReferences.add(AtriumPackage.eINSTANCE.getCFA_LinkedtoElement());
		return eReferences;
	}
