...
/**
 * <!-- begin-user-doc -->
* The '<em><b>[AssumptionAssociationQuery]</b></em>' BusinessQuery defined for 
* '<em><b>[AtriumPackage.eINSTANCE.getCFA_Assumption()]</b></em>'.
* <!-- end-user-doc -->
 * <p>
 * </p>
 *
 * @generated
 */
public class AssumptionAssociationQuery implements IBusinessQuery {
	...
	*/
	...
	public List<EObject> getCurrentElements(EObject elementP, boolean onlyGeneratedP) {
		...
		if (elementP instanceof CFA)
			currentsElements.addAll(((CFA) elementP).getAssumption());
	...
	public List<EReference> getEStructuralFeatures() {
		...
		eReferences.add(AtriumPackage.eINSTANCE.getCFA_Assumption());
		return eReferences;
	}
}
