 ...
 * <!-- end-user-doc -->
 * @see org.polarsys.capella.vp.atrium.Atrium.AtriumPackage#getstate_Type()
 * @model
 * @generated
 */
public enum state_Type implements Enumerator {
	/**
	 ...
	 * @ordered
	 */
	PROCESSED(0, "Processed", "Processed"), //$NON-NLS-1$ //$NON-NLS-2$
	 ...
	 * @ordered
	 */
	UNPROCESSED(1, "Unprocessed", "Unprocessed"); //$NON-NLS-1$ //$NON-NLS-2$
	 ...
	 * @generated
	 */
	private static final state_Type[] VALUES_ARRAY = new state_Type[] { PROCESSED, UNPROCESSED, };
	 ...
	 * @generated
	 */
	public static final List<state_Type> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
	 ...
	 * @generated
	 */
	public static state_Type get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			state_Type result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static state_Type getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			state_Type result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static state_Type get(int value) {
		switch (value) {
		case PROCESSED_VALUE:
			return PROCESSED;
		case UNPROCESSED_VALUE:
			return UNPROCESSED;
		}
		return null;
	}
	 ...
	 * @generated
	 */
	private state_Type(int value, String name, String literal) {
		this.value = value;
		this.name = name;
