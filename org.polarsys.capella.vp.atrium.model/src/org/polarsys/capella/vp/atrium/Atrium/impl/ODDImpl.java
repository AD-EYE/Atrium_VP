...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>ODD</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.polarsys.capella.vp.atrium.Atrium.impl.ODDImpl#getLinkedAssumption <em>Linked Assumption</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ODDImpl extends AtriumBasicElementImpl implements ODD {
	/**
	...
	protected EClass eStaticClass() {
		return AtriumPackage.Literals.ODD;
	}
		...
		if (linkedAssumption != null && linkedAssumption.eIsProxy()) {
			...
			if (linkedAssumption != oldLinkedAssumption) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AtriumPackage.ODD__LINKED_ASSUMPTION,
	...
	public void setLinkedAssumption(Assumption newLinkedAssumption) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AtriumPackage.ODD__LINKED_ASSUMPTION,
					oldLinkedAssumption, linkedAssumption));
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case AtriumPackage.ODD__LINKED_ASSUMPTION:
			if (resolve)
