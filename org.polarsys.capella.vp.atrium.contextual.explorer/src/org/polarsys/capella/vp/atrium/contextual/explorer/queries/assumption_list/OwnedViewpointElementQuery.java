...
package org.polarsys.capella.vp.atrium.contextual.explorer.queries.assumption_list;
...
public class OwnedViewpointElementQuery implements IQuery {
	...
	*/
	public List<Object> compute(Object object_p) {
		...
		Assumption_list object = (Assumption_list) object_p;

		for (EObject eObject : object.getAssumptions())
			result.add(eObject);
